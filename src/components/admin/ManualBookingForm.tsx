          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="pt-4 border-t border-gray-200 flex items-center justify-between">
              <button
                ...
                className="px-5 py-2.5 rounded-xl border border-gray-300 text-gray-700 font-bold text-sm hover:bg-gray-50 flex items-center gap-1.5 cursor-pointer"
              >
                <Icon name="ArrowLeftIcon" size={16} />
                Back to Menu &amp; Add-ons
              </button>
              ...
              <button
                ...
                className="px-8 py-3.5 rounded-xl font-extrabold text-sm text-white bg-gradient-to-r from-[#ED1C24] to-[#9C0C11] hover:shadow-xl hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center gap-2 disabled:opacity-50 cursor-pointer"
              >
                {loading ? (
                  <>Saving Booking...</>
                ) : (
